...
public class FormCliente extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnLer, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        boolean sucesso = ClienteController.inserirCliente(nome, email);
        if(sucesso){
            JOptionPane.showMessageDialog(this, "Inserção", "Registro inserido com sucesso", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Inserção", "Registro não inserido", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLerActionPerformed
        ...
        if(cliente != null){
            JOptionPane.showMessageDialog(this, "Registro encontrado", "Cliente", JOptionPane.INFORMATION_MESSAGE);
            txtNome.setText(cliente.getNome());
            txtEmail.setText(cliente.getEmail());
        } else {
            JOptionPane.showMessageDialog(this, "Registro não encontrado", "Cliente", JOptionPane.ERROR_MESSAGE);
        }
